...
public class EleventhScrLoad extends AppCompatActivity {
    mgdUtil tools;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_eleventh_scr_load);
        tools = EleventhGlobalCFG.getTools(this);
        ...
        splashUI.createSplashUI(this, EleventhContent.class, R.raw.loading);
    }
}